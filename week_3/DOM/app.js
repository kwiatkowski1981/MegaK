...
if (!localStorage.getItem(key)) {
  ...
  digits.innerText = localStorage.getItem(key) < 10
...
if (!localStorage.getItem(keyMouseDown)) {
  ...
  digitsMouseDown.innerText = localStorage.getItem(keyMouseDown) < 10
...
if (!localStorage.getItem(keyMouseUp)) {
  ...
  digitsMouseUp.innerText = localStorage.getItem(keyMouseUp) < 10
...
btnAddClick.addEventListener('click', (e) => {
  ...
  digits.innerHTML = localStorage.getItem(key) < 10
    ? `0${localStorage.getItem(key)}`
    : localStorage.getItem(key);
...
btnAddClick.addEventListener('mousedown', (e) => {
  ...
  digitsMouseDown.innerHTML = localStorage.getItem(keyMouseDown) < 10
    ? `0${localStorage.getItem(keyMouseDown)}`
    : localStorage.getItem(keyMouseDown);
});
